...
class inverter(rtl,eldo,thesdk):
    ...
    def __init__(self,*arg): 
        ...
        #_=rtl_iofile(self, name='control_write', dir='in', iotype='file') 
    ...
    #    # Input A is read to rtl simulation after 'initdo' is set to 1 by controller
    #    self.iofile_bundle.Members['A'].rtl_io_condition='initdone'
    #    # Output is read to rtl simulation when all of the utputs are valid, 
